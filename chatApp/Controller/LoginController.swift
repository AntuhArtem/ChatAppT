...
class LoginController: UIViewController {
    ...
    func setupInputsContainerView() {
        ...
        nameSeparatorView.topAnchor.constraint(equalTo: nameTextField.bottomAnchor).isActive = true //causes Thread SGPRT
        ...
        emailSeparatorView.topAnchor.constraint(equalTo: emailTextField.bottomAnchor).isActive = true //causes Thread SGPRT
